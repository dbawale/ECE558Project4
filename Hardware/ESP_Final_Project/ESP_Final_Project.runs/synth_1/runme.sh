...
HD_PWD='C:/Users/Vatsa/ESP_Final_Project/ESP_Final_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log n4fpga.vds -m64 -mode batch -messageDb vivado.pb -notrace -source n4fpga.tcl
