...
HD_PWD='C:/Users/Vatsa/ESP_Final_Project/ESP_Final_Project.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log n4fpga.vdi -applog -m64 -messageDb vivado.pb -mode batch -source n4fpga.tcl -notrace
