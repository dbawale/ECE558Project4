...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../bd/embsys/ipshared/xilinx.com/regbleddriver_v1_0/hdl" \
       +incdir+"$ref_dir/../../../bd/embsys/ipshared/xilinx.com/regbleddriver_v1_0/src" \
       +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" \
       +incdir+"$ref_dir/../../../ipstatic/clk_wiz_v5_3" \
       +incdir+"../../../../ESP_Final_Project.srcs/sources_1/bd/embsys/ipshared/xilinx.com/regbleddriver_v1_0/hdl" \
       +incdir+"../../../../ESP_Final_Project.srcs/sources_1/bd/embsys/ipshared/xilinx.com/regbleddriver_v1_0/src" \
